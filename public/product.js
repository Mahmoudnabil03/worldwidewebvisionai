import { initChrome, $, onLang, LANG, money, currency, esc, t } from './site.js?v=31';
import { CATEGORIES, findProduct as staticFind, imageFor, productDescription } from './catalog.js?v=31';
